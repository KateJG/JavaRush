    ...
    public static void cleanAllApartments(List<Apartment> apartments) {
        //написать тут вашу реализацию пунктов 1-4
            for (Apartment flat: apartments) {
                if(flat instanceof Apt1Room ) {
                    ((Apt1Room)flat).clean1Room();
                } else if(flat instanceof Apt2Room) {
                    ((Apt2Room)flat).clean2Rooms();
                } else if(flat instanceof Apt3Room) {
                    ((Apt3Room)flat).clean3Rooms();
                }
